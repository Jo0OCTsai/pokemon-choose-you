export default {
  ...
  edit: {
    ...
    remind: "Remind",
    tags: "Tags",
    noTags: "No tags yet—add some in Bag → Categories & Tags",
  ...
  dispatch: {
    ...
    needTag: "Add a Project-dimension tag first — dispatch routes by project tag (Bag → Categories & Tags).",
    noAgent: "No agent available yet: add and enable one in Bag → AI Agents first.",
    go: "Dispatch",
    working: "Dispatching…",
    launched:
  ...
  tagDispatch: {
    ...
    empty:
      'No project-dimension tags yet—switch a tag\'s dimension to "Project" in Categories & Tags to configure dispatch here.',
    foot: "Empty agent/dir falls back to the global default.",
    chipHint: 'Dispatch configured: manage it in the "Project Dispatch" card on the AI Agents tab',
    historyTip: 'Open "{name}" history in a new terminal (global default when no agent is set)',
    historyNone: "No agent available yet—set one up and enable it on the AI Agents tab",
  },
  dim: {
    project: "Project",
    context: "Context",
