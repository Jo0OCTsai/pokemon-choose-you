export default {
  ...
  focus: {
    ...
    petInputDesc: "Senses only how fast you type, never what you type; idle pet reacts softly to your keyboard",
  ...
  tagDispatch: {
    ...
    hint: "Todos with a project tag can be handed to an AI agent; configure the routing per tag here, one card per project.",
    agent: "Dispatch agent",
    agentDesc: "Todos of this project go to this agent first",
    agentNone: "Unspecified (global default)",
    workdir: "Working directory",
    workdirDesc: "Local path, or remote path over SSH; empty = agent's default",
    workdirPh: "~/projects/my-repo",
    context: "Project context",
    contextDesc: "Stack, caveats, etc. — joined into the dispatch prompt",
    ...
    foot: "Empty agent/dir falls back to the global default; changes apply after Save.",
