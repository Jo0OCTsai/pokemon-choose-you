export default {
  ...
  cats: {
    ...
    mainLabel: "主寶可夢",
    mainFollow: "跟隨第一個分類",
    mainHint: "沒有進行中任務時，桌寵展示主寶可夢；不設定則跟隨第一個分類的寶可夢。",
    spriteHint: "內建 6 隻自帶精靈圖；其餘寶可夢首次展示時從 PokéAPI 素材庫線上載入（斷網時暫不顯示）。",
    quotesTitle: "🎙 寶可夢台詞",
    quotesHint: "給選中的寶可夢寫專屬台詞：每行一句，點擊桌寵時隨機冒出；留空用預設台詞池。",
    quotesPh: "每行一句，例如：\n皮卡皮卡！今天也拜託了！\n訓練家，先試 5 分鐘？",
    quotesCount: "已寫 {n} 句",
    quotesSave: "儲存台詞",
  },
  ...
  tags: {
    ...
    release: "刪除",
    new: "＋ 新標籤",
    hint: "標籤按維度分組（專案/場景/人物/主題…），維度內開放生長。AI 從訊息產生待辦時會挑選合適的標籤；某維度沒有貼切選項且訊息有明確依據時，也會提議新標籤（建議卡上標 ＋，接受時才建立）。",
    namePh: "標籤名",
    ...
    single: "單選",
    dimHint:
      "同一維度內名字唯一；每條待辦最多掛 3 個標籤，專案維度至多 1 個。詞表外的 #新名字 在快速捕捉裡儲存時也會新增。",
    dimTitle: "🗂 標籤維度",
    dimNamePh: "新維度名稱",
    dimNew: "＋ 新維度",
    maxTags: "標籤數上限",
    dimManageHint:
      "維度少而穩（AI 協議裡的穩定標識）：改名/上限/停用可改，key 與單多選建後不可改；停用後不進新增與 AI 選項。",
  },
  dim: {
    project: "專案",
    context: "場景",
