...
[![CI](https://github.com/JoTsaiCN/pokemon-knock/actions/workflows/ci.yml/badge.svg)](https://github.com/JoTsaiCN/pokemon-knock/actions/workflows/ci.yml)
[![Release](https://github.com/JoTsaiCN/pokemon-knock/actions/workflows/release.yml/badge.svg)](https://github.com/JoTsaiCN/pokemon-knock/actions/workflows/release.yml)
...
- 收音机：飞书消息 → AI 识别待办 → 逐条「◎ 捕捉 / ✕ 逃走」，不强迫决策
...
- **飞书**：企业自建应用免公网回调，机器人所在会话增量轮询（间隔可调），断线指数退避
