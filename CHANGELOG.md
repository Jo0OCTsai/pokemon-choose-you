...
* 「先试 5 分钟」启动模式——零挫败入场券，到期不接休息 ([a2ce8e5](https://github.com/Jo0OCTsai/pokemon-knock/commit/a2ce8e5847b6be0264a331480cd4e5cd07c0d9e1))
...
* agent CLI 支持 SSH 远程执行——无头调用与历史入口经 ssh 转发 ([aefba50](https://github.com/Jo0OCTsai/pokemon-knock/commit/aefba507ed4e666955faf639afeb640418f92489))
...
* agent 会话回链与成本记录——分类调用自动落库，pk session 关联任务，弹窗可回放转录 ([606098f](https://github.com/Jo0OCTsai/pokemon-knock/commit/606098f4fcbd182bfcc986ab5892a973286052ae))
...
* pk skill install 一键分发 agent 技能（含命令速查与建议流程） ([4c34f48](https://github.com/Jo0OCTsai/pokemon-knock/commit/4c34f48a942bf58dc90a61d2c009c1800f714419))
...
* 收音机 AI 建议附判定理由与置信档位，逃走可选原因码并落反馈库 ([4b9ca67](https://github.com/Jo0OCTsai/pokemon-knock/commit/4b9ca6788d5ca4687bd26570b8e66cb27d406ab7))
...
* 改用 AI agent CLI 调用并提供 pk 命令行，移除链路观测 ([7286884](https://github.com/Jo0OCTsai/pokemon-knock/commit/7286884c2f58905c7ff75ccad3e69c4f5acdd31b))
...
* 数据导出/导入三件套——全量 JSON 往返、任务 CSV、日报 Markdown ([63ced12](https://github.com/Jo0OCTsai/pokemon-knock/commit/63ced126ecb330cfcecdf959109c233f91a91b3d))
...
* 桌宠就近可操作提醒——气泡带完成/推迟动作，免开主面板 ([297dfb4](https://github.com/Jo0OCTsai/pokemon-knock/commit/297dfb40604a76fe767cb2aba27d0503dedf1951))
...
* 每周复盘向导（训练师复盘）——路线逐站处置、草丛批量归位、每周提醒 ([df9e712](https://github.com/Jo0OCTsai/pokemon-knock/commit/df9e7124e33307840eda8c6c7280e33864789f15))
...
* 环境化倒计时——桌宠剩余时间色环、尾段焦急动画、长番茄钟轻提示音 ([72adbe4](https://github.com/Jo0OCTsai/pokemon-knock/commit/72adbe42071aa712056d6665f5d6fbec87e75a91))
...
* 相对截止时间——距现在的距离五档分色显示，悬停见绝对值，可关 ([2cda53e](https://github.com/Jo0OCTsai/pokemon-knock/commit/2cda53e56cafe5eead0f7dfac5aea6d8124e0532))
...
* 秘钥迁 OS 钥匙串（keyring），无钥匙串环境回落本地库 ([4bd68a7](https://github.com/Jo0OCTsai/pokemon-knock/commit/4bd68a70d4085c0c34eaab9e3419a8e2f43a5302))
...
* 自动版本化备份——VACUUM INTO 每日快照滚动保留，设置页可备份与恢复 ([980c0eb](https://github.com/Jo0OCTsai/pokemon-knock/commit/980c0eb768d090664fc124eec45b9087a69d7955))
...
* 自然语言快速捕捉——输入框解析时间/分类/标签，预览可取消、全局可关 ([721f630](https://github.com/Jo0OCTsai/pokemon-knock/commit/721f6304929d4ee93b4abfae541987128231ebf4))
...
* 逾期 fresh start——冒险页折叠羞耻墙，一键/每日自动归草丛 ([b906ee8](https://github.com/Jo0OCTsai/pokemon-knock/commit/b906ee86636f7c921112cabc1569244b22144ebe))
...
* 飞书拉取引擎可切换——官方 lark-cli（api --format json，凭证自管）与内置直连并存 ([28690a0](https://github.com/Jo0OCTsai/pokemon-knock/commit/28690a0b329e3ebab48683c46813f98a9979d550))
...
* bundle targets 显式列表去掉 MSI，Windows 只出 NSIS ([775e01b](https://github.com/Jo0OCTsai/pokemon-knock/commit/775e01b0aafa9e5a67157fe6ff05803dd55301df))
...
* bundle targets 补 app 目标，恢复 macOS 更新包产出 ([2af64e8](https://github.com/Jo0OCTsai/pokemon-knock/commit/2af64e89fa95bc005c21baa27a2a055802acf2a3))
...
* **deps:** update npm dependencies ([f1c1be4](https://github.com/Jo0OCTsai/pokemon-knock/commit/f1c1be48f19486d00b8e540f56c7bc71cb185de7))
...
* universal sidecar 双架构构建后 lipo 合成胖二进制 ([dfa3b71](https://github.com/Jo0OCTsai/pokemon-knock/commit/dfa3b71afe377bdd43a887c2037b9af094bf14f2))
...
* 修复 release 打包的 pk sidecar（Windows .exe 占位与 universal 目标） ([1ca41aa](https://github.com/Jo0OCTsai/pokemon-knock/commit/1ca41aaa0e5b2099bf157e1f518206b069b84380))
