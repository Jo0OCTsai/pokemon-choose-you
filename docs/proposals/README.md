...
| [TAG_SYSTEM_PROPOSAL.md](TAG_SYSTEM_PROPOSAL.md) | 标签体系维度化 + AI 自动治理 | P1–P3 已落地，P4–P5 未实施 |
| [MEMORY_KNOWLEDGE_PROPOSAL.md](MEMORY_KNOWLEDGE_PROPOSAL.md) | 分层记忆 + 本地知识检索 | 方案（未实施） |
| [AGENT_DISPATCH_PROPOSAL.md](AGENT_DISPATCH_PROPOSAL.md) | 待办驱动的 Agent 调度 | 设计提案（未实施） |
